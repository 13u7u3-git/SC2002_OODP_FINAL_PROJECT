...
public class ApplicantMenu extends Menu {
   ...
   public void handleInput() {
      while (true) {  // Keep asking until valid input
         try {
            java.lang.String input = scanner.nextLine().trim();
   ...
   public void handleViewAvailableProjects() {
      try {
         List<String> allProjects = applicantController.getEligibleProjects();
         ...
         List<String> filteredProjects = userFilterManager.applyFilters(allProjects, currentUser);
   ...
   private void printProjectsTable(List<String> projects) {
   ...
   public void handleApplyForBTOProject() {
      try {
         ...
         List<String> eligibleProjects = applicantController.getEligibleProjects();
         ...
         String selectedProject; // Declare here to store the chosen project
         ...
         while (true) {
            ...
            Optional<String> foundProjectOpt = applicantController.validateUserApplicationInput(eligibleProjects, input);
         ...
         if (twoRoomUnits > 0 && threeRoomUnits > 0) {
            ...
            while (true) {
               ...
               java.lang.String flatChoiceInput = scanner.nextLine().trim();
   ...
   public void handleViewApplicationStatus() {
      try {
         ...
         for (Application app : myApplications) {
            tableData.add(List.of(
                    java.lang.String.valueOf(app.getId()),
                    app.getProjectName().getProjectName(),
   ...
   public void handleRequestWithdrawal() {
      try {
         ...
         Color.println("Project Name      : " + applicationToWithdraw.getProjectName().getProjectName(), Color.CYAN);
         ...
         java.lang.String confirm = scanner.nextLine().trim().toUpperCase();
   ...
   public void handleSubmitEnquiry() {
      try {
         ...
         List<String> availableProjects = applicantController.getEligibleProjects();
         ...
         String selectedProject; // Declare here
         ...
         while (true) {
            ...
            Optional<String> foundProjectOpt;
            try {
         ...
         java.lang.String enquiryText = scanner.nextLine().trim();
   ...
   public void handleViewMyEnquiries() {
      try {
         List<List<java.lang.String>> enquiryData = applicantController.getMyEnquiriesAsTableData();
