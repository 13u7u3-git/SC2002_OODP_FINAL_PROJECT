...
public class UserFilterManager {
   ...
   public List<String> applyFilters(List<String> projects, User currentUser) {
      Predicate<String> combinedFilter = getProjectPredicate(currentUser.getFilterSettings());
         ...
         try {
            ...
            switch (choice) {
               ...
               case 4 -> {
                  ...
                  java.lang.String dateInput = scanner.nextLine().trim();
                  try {
   ...
   private Predicate<String> getProjectPredicate(UserFilterSettings filters) {
      Predicate<String> combinedFilter = p -> true;
